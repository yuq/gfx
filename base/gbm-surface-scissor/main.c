...
void Render(int i)
{
	...
	if (!i) {
	  ...
	  glScissor(0, 0, TARGET_SIZE, TARGET_SIZE);
	  ...
	  glViewport(TARGET_SIZE/4, TARGET_SIZE/4, TARGET_SIZE/2, TARGET_SIZE/2);
	  glScissor(TARGET_SIZE/4, TARGET_SIZE/4, TARGET_SIZE/2, TARGET_SIZE/2);
