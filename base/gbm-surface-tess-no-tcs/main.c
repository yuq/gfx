...
void Render(void)
{
	...
	glPatchParameterfv(GL_PATCH_DEFAULT_OUTER_LEVEL, (GLfloat[]){3.0, 4.0, 5.0, 0.0});
	glPatchParameterfv(GL_PATCH_DEFAULT_INNER_LEVEL, (GLfloat[]){3.0, 0.0, 0.0, 0.0});
	...
	glDrawElements(GL_PATCHES, sizeof(index)/sizeof(GLushort), GL_UNSIGNED_SHORT, index);
